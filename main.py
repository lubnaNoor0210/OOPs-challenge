...
class Recipe:
    def __init__(self, name: str, image_url: str, instructions: str):
        self.name = name
...
class RecipeApp:
    def __init__(self):
        self.api = RecipeAPI("https://www.themealdb.com/api/json/v1/1/filter.php?a=Chinese")
        self.recipe_list = []
    ...
    <div class="centered-paragraph">
        Join us on a flavorful journey where we explore delicious dishes from around the world. From traditional family recipes to modern twists, this is your one-stop destination for culinary inspiration. Let's make cooking a fun and delightful experience!
    </div>
""", unsafe_allow_html=True)
